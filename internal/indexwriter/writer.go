// Package indexwriter provides WriteV2, which encodes IVF-HNSW index files
// in the v2 binary format defined in internal/index/format_v2.go.
// Keeping the writer in its own package (rather than in cmd/preprocess) lets
// tests import it directly without pulling in the full preprocessor binary.
package indexwriter
...
// WriteV2 takes the float32 vectors+labels+centroid assignments and writes
// the v2 IVF-HNSW format to dstPath. It:
//
